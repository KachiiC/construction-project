...
export const Terms = () => {
  return (
    <div className="terms-container">
      <h1 className="terms-container-title">Terms and Conditions</h1>
      <h1>1. AGREEMENT TO TERMS</h1>
      <p>
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (“you”) and VVS
        Property Group, doing business as VVS Property Group ("VVS Property
        Group," “we," “us," or “our”), concerning your access to and use of the
        http://www.vvsproperty.co.uk website as well as any other media form,
        ...
        registered in the United Kingdom and have our registered office at 9
        limes grove , beckenham, london br36ns. Our VAT number is 415680791. You
      ...
      <p>
        ...
        you have received parental permission to use the Site; (3) you will not
        access the Site through automated or non-human means, whether through a
        bot, script, or otherwise; (4) you will not use the Site for any illegal
        or unauthorized purpose; and (5) your use of the Site will not violate
      ...
      <p>
        ...
        provisions of the law of your country of residence. VVS Property Group
        and yourself both agree to submit to the non-exclusive jurisdiction of
        the courts of london, which means that you may make a claim to defend
        your consumer protection rights in regards to these Terms of Use in the
      ...
      <p>
        <b>Address: </b>VVS Property Group, 9 Limes Grove Beckenham, London,
        United Kingdom BR3 6NS
      </p>
      <p>
        <b>Phone:</b> 07437028636 bwohlman@vvsproperty.co.uk
      </p>
    </div>
  );
};
